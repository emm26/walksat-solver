...
class RandomInterpretation():
    ...
    def get_interpretation_with_changed_variable_sense(self, variable_to_change):
...
class Solver():
    ...
    def solve(self, formula, num_vars, max_flips = 10, rnd_walk = 0.1, max_restarts = 5):
        """
        ...
        for _ in xrange(max_restarts):
            ...
            for _ in xrange(max_flips):
                ...
                for var in unsatisfied_clause:
                    ...
                    current_unsatisified_clauses = RandomInterpretation.count_unsatisfiable_clauses(current_interpretation, formula)
                ...
                print least_unsatisified_clauses
